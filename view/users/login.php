...
<head>
  ...
  <title>Onlineshoping | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>user/login"><b>Online</b>Shoping</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="<?php echo base_url();?>user/login" method="post" id="login">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="btnSave">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
